...
typedef struct {
    ...
    void (*emit_add)(string_builder_t*, const char* dst, const char* src);
    void (*emit_mov_direct)(string_builder_t*, const char* dst, int value);
    void (*emit_syscall)(string_builder_t*);

    void (*emit_cmp)(string_builder_t*, const char* a, const char* b);

    void (*emit_jmp)(string_builder_t*, const char* chunk);
    void (*emit_jmp_equal)(string_builder_t*, const char* chunk);
    void (*emit_jmp_not_equal)(string_builder_t*, const char* chunk);
    void (*emit_jmp_greater_than)(string_builder_t*, const char* chunk);
    void (*emit_jmp_greater_than_equal)(string_builder_t*, const char* chunk);
    void (*emit_jmp_lower_than)(string_builder_t*, const char* chunk);
    void (*emit_jmp_lower_than_equal)(string_builder_t*, const char* chunk);

    void (*emit_call)(string_builder_t*, const char* name);

    void (*emit_inc)(string_builder_t*, const char* reg);
    void (*emit_dec)(string_builder_t*, const char* reg);

    void (*emit_stack_setup)(string_builder_t*, int size);
